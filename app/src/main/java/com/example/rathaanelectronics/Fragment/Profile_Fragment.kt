...
import com.example.rathaanelectronics.Activity.IntroActivity
...
class Profile_Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        ll_edit_profile?.setOnClickListener { view ->
            ...
            changeFragemnt(com.example.rathaanelectronics.Fragment.EditProfileFragment.newInstance(profileData!!,""))
        }

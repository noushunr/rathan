...
class Delivery_state_select_adress_Fragment : Fragment(), AddressItemClick {
    ...
    val addAddressFragment =
        com.example.rathaanelectronics.ui.Fragment.AddAddressFragment()
    ...
    lateinit var adapter : com.example.rathaanelectronics.ui.Adapter.AddressListAdapter
                ...
                if (response.isSuccessful()) {
                    ...
                    if (status == "true") {
                        ...
                        if (addressList != null && addressList?.size > 0) {
                            adapter =
                                com.example.rathaanelectronics.ui.Adapter.AddressListAdapter(
                                    activity,
                                    addressList!!,
...
//                        emptyText.isVisible = true
    ...
    override fun editAddressItem(addressItem: AddressResponseModel.Details) {
        ...
        changeFragemnt(com.example.rathaanelectronics.ui.Fragment.AddAddressFragment.newInstance(addressItem,""))
    }

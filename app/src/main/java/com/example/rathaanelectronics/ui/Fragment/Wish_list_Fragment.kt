...
import com.example.rathaanelectronics.ui.Adapter.WishListAdapter
            ...
            override fun onResponse(
                ...
                if (response.isSuccessful()) {
                    ...
                    if (status == "true") {
                        ...
                        wishlistRecycler.adapter = WishListAdapter(activity,wishListData!!,this@Wish_list_Fragment,manager?.locale.equals("ar"))
                    }else{
